// NOTE: This is a copy of revm-handler's frame.rs that we'll customize later
// to support delta-based balance transfers instead of immediate transfers.
// For now, it's kept identical to the original.
#![allow(dead_code, unreachable_pub)]

// Imports from revm crates
use core::cmp::min;
use revm::{
    context_interface::{
    ...
    handler::{
        CallFrame, CreateFrame, FrameData, FrameResult, FrameTr, ItemOrResult, PrecompileProvider,
    },
    interpreter::{
        ...
        InterpreterResult, InterpreterTypes, SharedMemory, gas,
...
// Re-export derive_where from dependencies
use derive_where::derive_where;

// Type alias for FrameInitOrResult
pub type FrameInitOrResult<F> = ItemOrResult<FrameInit, <F as FrameTr>::FrameResult>;
